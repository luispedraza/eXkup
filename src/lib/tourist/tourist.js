(function() {
  ...
  */
  ...
  Tourist.Tip.Base = (function() {
    ...
    Base.prototype.skipButtonTemplate = '<button class="btn btn-default btn-sm pull-right tour-next">Saltar →</button>';

    Base.prototype.nextButtonTemplate = '<button class="btn btn-primary btn-sm pull-right tour-next">Siguiente →</button>';

    Base.prototype.finalButtonTemplate = '<button class="btn btn-primary btn-sm pull-right tour-next">Terminar</button>';

    Base.prototype.closeButtonTemplate = '<a class="btn btn-close tour-close" href="#"><i class="fa fa-times"></i></a>';
    ...
    Base.prototype.actionLabels = ['HAZ ESTO:', 'LUEGO ESTO:', 'DESPUÉS ESTO:'];
    ...
    */
    ...
    Base.prototype._buildContentElement = function(step) {
      ...
      content = $($.parseHTML(this.template({
        ...
        counter: step.final ? '' : "paso " + (step.index + 1) + " de " + step.total,
