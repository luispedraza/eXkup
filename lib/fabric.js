  ...
  fabric.FreeDrawing = fabric.util.createClass({
   ...
   /**
    ...
    _finalizeAndAddPath: function() {
      ...
      path = path.join('');
      /* LPG */
      if (path.match("M 0 0 Q 0 0 0 0 L 0 0")) {
  ...
  fabric.Object = fabric.util.createClass(/** @scope fabric.Object.prototype */ {
    ...
    toObject: function(propertiesToInclude) {
      ...
      var object = {
        ...
        angle:            toFixed(this.get('angle'), NUM_FRACTION_DIGITS),
        flipX:            this.flipX,
        flipY:            this.flipY,
...
/////////////////////////////////////
  ...
  // for (var i = proto.stateProperties.length; i--; ) {
    // if (!proto['getAngle']) {
    //   proto['getAngle'] = function() {return this['angle']}
    // }
    // if (!proto['settAngle']) {
    //   proto['setAngle'] = function(val) {this['angle'] = val}
    // }
    // if (!proto['getTop']) {
    //   proto['getTop'] = function() {return this['top']}
    // }
    // if (!proto['setTop']) {
    //   proto['setTop'] = function(val) {this['top'] = val}
    // }
    // if (!proto['getLeft']) {
    //   proto['getLeft'] = function() {return this['left']}
    // }
    // if (!proto['setLeft']) {
    //   proto['setLeft'] = function(val) {this['left'] = val}
    // }
    // if (!proto['getWidth']) {
    //   proto['getWidth'] = function() {return this['width']}
    // }
    // if (!proto['setWidth']) {
    //   proto['setWidth'] = function(val) {this['width'] = val}
    // }
    // if (!proto['getHeight']) {
    //   proto['getHeight'] = function() {return this['height']}
    // }
    // if (!proto['setHeight']) {
    //   proto['setHeight'] = function(val) {this['height'] = val}
    // }
    // if (!proto['getScaleX']) {
    //   proto['getScaleX'] = function() {return this['scaleX']}
    // }
    // if (!proto['setScaleX']) {
    //   proto['setScaleX'] = function(val) {this['scaleX'] = val}
    // }
    // if (!proto['getScaleY']) {
    //   proto['getScaleY'] = function() {return this['scaleY']}
    // }
    // if (!proto['setScaleY']) {
    //   proto['setScaleY'] = function(val) {this['scaleY'] = val}
    // }
    // if (!proto['getFlipX']) {
    //   proto['getFlipX'] = function() {return this['flipX']}
    // }
    // if (!proto['setFlipX']) {
    //   proto['setFlipX'] = function(val) {this['flipX'] = val}
    // }
    // if (!proto['getFlipY']) {
    //   proto['getFlipY'] = function() {return this['flipY']}
    // }
    // if (!proto['setFlipY']) {
    //   proto['setFlipY'] = function(val) {this['flipY'] = val}
    // }
    // if (!proto['getTransformMatrix']) {
    //   proto['getTransformMatrix'] = function() {return this['transformMatrix']}
    // }
    // if (!proto['setTransformMatrix']) {
    //   proto['setTransformMatrix'] = function(val) {this['transformMatrix'] = val}
    // }
    // if (!proto['getFillRule']) {
    //   proto['getFillRule'] = function() {return this['fillRule']}
    // }
    // if (!proto['setFillRule']) {
    //   proto['setFillRule'] = function(val) {this['fillRule'] = val}
    // }
    // if (!proto['getStroke']) {
    //   proto['getStroke'] = function() {return this['stroke']}
    // }
    // if (!proto['setStroke']) {
    //   proto['setStroke'] = function(val) {this['stroke'] = val}
    // }
    // if (!proto['getStrokeWidth']) {
    //   proto['getStrokeWidth'] = function() {return this['strokeWidth']}
    // }
    // if (!proto['setStrokeWidth']) {
    //   proto['setStrokeWidth'] = function(val) {this['strokeWidth'] = val}
    // }
    // if (!proto['getStrokeDashArray']) {
    //   proto['getStrokeDashArray'] = function() {return this['strokeDashArray']}
    // }
    // if (!proto['setStrokeDashArray']) {
    //   proto['setStrokeDashArray'] = function(val) {this['strokeDashArray'] = val}
    // }
    // if (!proto['getBorderScaleFactor']) {
    //   proto['getBorderScaleFactor'] = function() {return this['borderScaleFactor']}
    // }
    // if (!proto['setBorderScaleFactor']) {
    //   proto['setBorderScaleFactor'] = function(val) {this['borderScaleFactor'] = val}
    // }
    // if (!proto['getFill']) {
    //   proto['getFill'] = function() {return this['fill']}
    // }
    // if (!proto['setFill']) {
    //   proto['setFill'] = function(val) {this['fill'] = val}
    // }
    // if (!proto['getOverlayFill']) {
    //   proto['getOverlayFill'] = function() {return this['overlayFill']}
    // }
    // if (!proto['setOverlayFill']) {
    //   proto['setOverlayFill'] = function(val) {this['overlayFill'] = val}
    // }
    // if (!proto['getFillRule']) {
    //   proto['getFillRule'] = function() {return this['fillRule']}
    // }
    ...
    //   proto['setFillRule'] = function(val) {this['fillRule'] = val}
    // }
    // if (!proto['getSelectable']) {
    //   proto['getSelectable'] = function() {return this['selectable']}
    // }
    // if (!proto['setSelectable']) {
    //   proto['setSelectable'] = function(val) {this['selectable'] = val}
    // }
       /********** Solución problema Chrome ********/
    // getAngle: function() {
    //   return this['angle'];
    // },
    proto["setAngle"] = function(val) {
      this['angle'] = val;
    }
    // getLeft: function() {
    //   return this['left'];
...
(function(global) {
  ...
  fabric.Polygon = fabric.util.createClass(fabric.Object, /** @scope fabric.Polygon.prototype */ {
     ...
     */
    _render: function(ctx) {
      // LPG para que pueda haber polígonos sin puntos (recorte poligonal)
  ...
  fabric.Group = fabric.util.createClass(fabric.Object, /** @scope fabric.Group.prototype */ {
    ...
    _restoreObjectState: function(object) {
      ...
      var groupLeft = this.get('left'),
          ...
          groupAngle = this.get('angle') * (Math.PI / 180),
      ...
      object.set('angle', object.get('angle') + this.get('angle'));
...
(function(global) {
  ...
  fabric.Text.fromElement = function(element, options) {
    ...
    */
    ...
    text.set({
      left: text.get('left') + text.get('width') / 2,
      top: text.get('top') - text.get('height') / 2
    });
